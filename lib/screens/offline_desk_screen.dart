...
class _OfflineDeskScreenState extends State<OfflineDeskScreen> {
  ...
  Widget build(BuildContext context)=>Scaffold(appBar:AppBar(title:const Text('Mi espacio sin conexión')),body:ListView(padding:const EdgeInsets.all(20),children:[
    ...
    const SizedBox(height:18),TextField(contextMenuBuilder: privacyTextMenu, controller:_text,maxLines:9,maxLength:8000,decoration:const InputDecoration(labelText:'Mi borrador privado en este equipo',alignLabelWithHint:true)),
