...
class CompanyAssistantPanel extends StatefulWidget{
 ...
 const CompanyAssistantPanel({super.key,this.service,this.description='Inteligencia artificial mexicana creada por ANGEL ZALDÍVAR. Pregunta cómo realizar una actividad; consultaré los manuales publicados para tu cuenta.',this.example='Ejemplo: “¿Cómo uso el control del sauna?”\nIncluye el modelo o equipo para encontrar el procedimiento correcto.'});
...
class _CompanyAssistantState extends State<CompanyAssistantPanel>{
 ...
 @override Widget build(BuildContext context)=>Column(children:[Expanded(child:ListView(padding:const EdgeInsets.all(18),children:[
  const Text('Online Smart · Sauna Stilo',style:TextStyle(fontSize:22,fontWeight:FontWeight.w800)),const SizedBox(height:8),Text(widget.description,style:const TextStyle(color:Colors.white60,height:1.5)),
