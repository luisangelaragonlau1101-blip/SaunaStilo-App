...
class AppActionCatalog {
  ...
  static List<AppAction> forUser(UserModel user) {
    ...
    final actions = <AppAction>[
      ...
      AppAction(id: 'juegos', title: 'Pausa Stilo · Juegos', subtitle: 'Gato con el equipo y juegos locales', icon: Icons.sports_esports_rounded, color: _violet, keywords: const ['jugar','memoria','gato'], builder: (_) => TeamGamesScreen(user: user)),
